...
function lfStory(m){
  ...
  const actions=m.private?'':(
    '<div class="lfActions"><div class="lfReactions">'+lfReactionButtons(m)+'</div>'+
    (lfCtx?.isAdmin?'<button type="button" class="lfShare" data-lf-share="'+lfEsc(m.id)+'">WhatsApp</button>':'')+
    '</div>'
  );
